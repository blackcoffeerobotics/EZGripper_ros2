...
PKG_DIR = get_package_share_directory("ezgripper_dual_gen1_moveit_config")
...
robot_description_config = xacro.process_file( \
        os.path.join(get_package_share_directory("ezgripper_driver"), \
            "urdf", "dual_gen1", \
                "ezgripper_dual_gen1_standalone.urdf.xacro")
    )
...
robot_description_semantic = { \
    "robot_description_semantic": load_params( \
        "config/ezgripper_dual_gen1.srdf", is_yaml= False)}
